    ...
    const menu = [
        {
            ...
            items: [
                    ...
                    { label: 'Top Accounts by Product', icon: 'pi pi-fw pi-table', to: '/table' }]
        },
        {
            ...
            items: [
                ...
                { label: 'Product Management', icon: 'pi pi-fw pi-user-edit', to: '/crud' },
                { label: 'Product Assortment Preview', icon: 'pi pi-fw pi-list', to: '/list' },
